               ...
               <header>
                ...
                <form method="POST">
                    <div class="inputs-container">
                        <div>
                            <img src="images/email.png"><input type="email" name="email" placeholder="E-mail">
                        </div>
                        <div>
                            <img src="images/key.png"><input type="password" name="password" placeholder="Senha"><img src="images/eye.png">
                        </div>
                    </div>
